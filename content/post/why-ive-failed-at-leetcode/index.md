...
description: We all make mistakes. Learning from them and moving forward is what we owe ourselves.
...
What I'm trying to convey is that everyone's journey to becoming successful with LeetCode/DSA
problems can look different, even if some of the conclusions reached end up being the same.

# Setting the Stage

This is one of my favorite quotes from any book, and it seems especially relevant now.
...
Dalinar from *Oathbringer*, by Brandon Sanderson
...
I coded like I had no idea what I was doing. So, how in the world did I reach that point?
...
me with life-changing salary. I walked into the interview feeling
like I was ready for anything.

# The Interview

The first portion of the interview went well as it was the standard "explain to me
in detail things you've built". If you can't tell, I can talk about things I've done all day long. We were about two-thirds of the way done and I was
confident I had the interview in the bag. Then, the interviewer said we needed to switch gears to the coding part of the interview. I'm pretty sure I froze like a deer.
I said that I was told there wouldn't be coding during this interview, to which the
interviewer said that was a mistake and appologized profusefully. I wasn't remotely in the mindset to battle LeetCode, but saying no wasn't an option. The problem itself
...
I even said outloud, "Well, I could use the Python Counter (for those who are not Python
...
of the character)....but nah, that's too easy and there's
probably a more efficient way to do this". **I had it. I had 75% of a valid answer in my hands.**
The interviewer suggested I try that approach even if it wasn't optimal (hint: always listen to your interviewer). This solution would have been $\mathcal{O}(n)$, which is perfectly fine.

Still, I didn't listen because my brain was hyper-focused on what I thought
was the ideal solution: a two-pointer approach! Why a two pointer approach? I had the vague idea that if I had the left index pointed at a possible unique character, the
right index could iterate through the characters after it looking for a duplicate, and then jumping the left index to the index of the right if I found a duplicate. After talking through the solution out loud, I dove into coding the solution.

I was getting very anxious, and this is when things went off the rails. SiI started making simple mistakes like forgetting the Python typing syntax and forgetting what variable names I
...
I wiped out most of my code and used a Counter. I hoped because I was allowed extra time to complete the task
...
cut it anymore? Maybe I wasn't that good? Maybe I never was?

# Turning the Corner

You see, we are our own best and worst storytellers. It's easy to believe our thoughts,
and it's challenging to work against them. Since I was just sitting around and definitely didn't want to touch a computer, I took my wife's advice and listened to audiobooks. There was one book in particular called *Self Compassion* that my wife had been begging me to read for years. The book's tagline started with "Stop beating yourself up", so it seemed like the medicine I needed. I'll save the details of my experiences
...
more was only causing suffering, which serves no purpose. Beating yourself up has no correlation with actually improving a skill. Something about the
...
Sometimes knowing the answer or what you should do isn't enough. I had to walk
the path, experience the pain, and have my own revelation for it to be concrete and
real to me. It was only then that it was "real" and meaningful to me.
